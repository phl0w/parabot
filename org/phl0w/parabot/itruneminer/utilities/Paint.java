...
public class Paint {
    ...
    public static void onRepaint(Graphics g) {
        final int levelsGained = Utilities.getLevel(Skill.MINING) - iTRuneMiner.startLevel;
        final int xpGained = Skill.MINING.getExperience() - iTRuneMiner.startXp;
        ...
        g2d.setFont(title);
        g2d.drawString("iTRuneMiner", 12, 43);
        g2d.setFont(author);
        g2d.drawString("By: _phl0w", 12, 58);
        g2d.setFont(info);
        g2d.drawString("Runtime: " + Utilities.formatRuntime(iTRuneMiner.startTime), 12, 78);
        g2d.drawString("Mining: " + Utilities.getLevel(Skill.MINING) + " (+" + levelsGained + ")", 12, 93);
        g2d.drawString("XP gained: " + xpGained, 12, 108);
        g2d.drawString("XP/h: " + Utilities.getPerHour(xpGained), 12, 123);
        g2d.drawString("Ores mined: " + iTRuneMiner.mined, 12, 138);
        g2d.drawString("Ore/h: " + Utilities.getPerHour(iTRuneMiner.mined), 12, 153);
        g2d.drawString("Status: " + iTRuneMiner.status, 12, 168);
    }
}
