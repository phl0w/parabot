...
public class Utilities {
    ...
    public static boolean isMakeScreenOpen() {
        return Loader.getClient().getOpenInterfaceId() == 26700;
    }
    ...
    public static int getPerHour(final int variable) {
        return (int) (variable * 3600000D / (System.currentTimeMillis() - iTMahoganyBenches.startTime));
    }
