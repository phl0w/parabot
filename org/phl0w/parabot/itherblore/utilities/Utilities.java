...
public class Utilities {
    ...
    public static boolean isWithdrawAmountScreenOpen() {
        return Loader.getClient().getBackDialogId() == 23350;
    }
    ...
    public static int getPerHour(final int variable) {
        return (int) (variable * 3600000D / (System.currentTimeMillis() - iTHerblore.startTime));
    }
