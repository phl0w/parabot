...
public class Paint {
    ...
    public static void onRepaint(Graphics g) {
        ...
        g2d.setFont(title);
        g2d.drawString("iTBuyer", 12, 43);
        g2d.setFont(author);
        g2d.drawString("By: _phl0w", 12, 58);
        g2d.setFont(info);
        g2d.drawString("Runtime: " + Utilities.formatRuntime(iTBuyer.startTime), 12, 78);
        g2d.drawString("Items bought: " + itemsBought, 12, 93);
        g2d.drawString("Items bought/h: " + Utilities.getPerHour(itemsBought), 12, 108);
        g2d.drawString("Status: " + iTBuyer.status, 12, 123);
