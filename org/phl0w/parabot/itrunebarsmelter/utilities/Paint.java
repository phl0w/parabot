...
public class Paint {
    ...
    public static void onRepaint(Graphics g) {
        final int levelsGained = Utilities.getLevel(Skill.SMITHING) - iTRuneBarSmelter.startLevel;
        final int xpGained = Skill.SMITHING.getExperience() - iTRuneBarSmelter.startXp;
        ...
        g2d.setFont(title);
        g2d.drawString("iTRuneBarSmelter", 12, 43);
        g2d.setFont(author);
        g2d.drawString("By: _phl0w", 12, 58);
        g2d.setFont(info);
        g2d.drawString("Runtime: " + Utilities.formatRuntime(iTRuneBarSmelter.startTime), 12, 78);
        g2d.drawString("Smithing: " + Utilities.getLevel(Skill.SMITHING) + " (+" + levelsGained + ")", 12, 93);
        g2d.drawString("XP gained: " + xpGained, 12, 108);
        g2d.drawString("XP/h: " + Utilities.getPerHour(xpGained), 12, 123);
        g2d.drawString("Bars smelted: " + iTRuneBarSmelter.smelted, 12, 138);
        g2d.drawString("Bars/h: " + Utilities.getPerHour(iTRuneBarSmelter.smelted), 12, 153);
        g2d.drawString("Status: " + iTRuneBarSmelter.status, 12, 168);
    }
}
