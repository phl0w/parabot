package org.phl0w.parabot.itimplinghunter.user;
...
public class Paint {
    ...
    private static final Shape bg = new Rectangle(10, 23, 170, 120);
    private static final Shape border = new Rectangle(8, 21, 170, 124);
    ...
    public static void onRepaint(Graphics g) {
        ...
        g.drawString("Money: " + (Utilities.getMoney() - iTImplingHunter.startMoney), 12, 105);
        g.drawString("Hunter: " + Utilities.getLevel(Skill.CONSTRUCTION) + " (+" + (Utilities.getLevel(Skill.CONSTRUCTION) - iTImplingHunter.startLevel) + ")", 12, 117);
        g.drawString("XP gained: " + (Skill.CONSTRUCTION.getExperience() - iTImplingHunter.startXp), 12, 129);
    }
}
